...
{
    /// <inheritdoc />
    public partial class AddSubcategoryAndAd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdGUID = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    TargetURL = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    PublishDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ad", x => x.AdGUID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ad_CityId_DeletedInd_PublishDate",
                table: "Ad",
                columns: new[] { "CityId", "DeletedInd", "PublishDate" });
