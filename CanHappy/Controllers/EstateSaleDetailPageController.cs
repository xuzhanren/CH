...
public class EstateSaleDetailPageController(ApplicationDbContext context, IWebHostEnvironment environment, IConfiguration configuration) : Controller
{
    ...
    {
        ViewData["EstateSaleDetailSliderWaitSeconds"] = Math.Max(0, configuration.GetValue<int?>("EstateSaleDetailSliderWaitSeconds") ?? 2);
        ViewData["EstateSaleDetailAdSlidingInterval"] = Math.Max(1, configuration.GetValue<int?>("EstateSaleDetailAdSlidingInterval") ?? 5);
        ViewData["EstateSaleDetailAdSliderFadingMode"] = configuration.GetValue<string>("EstateSaleDetailAdSliderFadingMode") ?? "homeAdFade";
        ViewData["EstateSaleDetailAdPixelResolveTransitionPeriodMiliSeconds"] = Math.Max(100, configuration.GetValue<int?>("estateSaleDetailAdPixelResolveTransitionPeriodMiliSeconds") ?? 1000);
        ViewData["EstateSaleDetailAdFadeTransitionMilliSeconds"] = Math.Max(100, configuration.GetValue<int?>("estateSaleDetailAdFadeTransitionMilliSeconds") ?? 450);
        ViewData["EstateSaleDetailSlideTransitionMilliSeconds"] = Math.Max(100, configuration.GetValue<int?>("estateSaleDetailSlideTransitionMilliSeconds") ?? 650);
        ViewData["EstateSaleDetailAdSlideDistancePercent"] = Math.Clamp(configuration.GetValue<int?>("estateSaleDetailAdSlideDistancePercent") ?? 8, 1, 30);
        ViewData["EstateSaleDetailAdTransitionEasing"] = configuration.GetValue<string>("estateSaleDetailAdTransitionEasing") ?? "ease-in-out";
